...
- مستوى الجودة في كل بناء (إلزامي — مستوى الاستوديوهات العالمية): سلّم منتجًا حقيقيًا غنيًا ومتكاملًا، مش نموذجًا مختصرًا: حجم متوقع من 600 إلى 1200 سطر حسب حجم الطلب، وكل الشاشات والحالات موجودة فعلاً (رئيسية كاملة + حالات فراغ وخطأ وتحميل ونجاح + إعدادات أو مساعدة لو تنفع)، ومحتوى حقيقي غني من أول تشغيل — ممنوع نهائيًا Lorem Ipsum أو نصوص الحشو أو الأزرار الشكلية التي لا تعمل.
